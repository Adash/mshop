...
use Yoda\UserBundle\Form\OrdersType;
...
class OrdersController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('UserBundle:Orders')->findAll();
     ...
     * @Method("POST")
     * @Template("UserBundle:Orders:new.html.twig")
     */
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('UserBundle:Orders')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("UserBundle:Orders:edit.html.twig")
     */
